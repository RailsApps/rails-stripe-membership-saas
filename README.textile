...
1. Clone the branch into your system, setting up a branch called rails4 :

<pre>
$ git clone -b rails4 https://github.com/kathyonu/rails-stripe-membership-saas.git@ 
</pre>
...
2a. Using your favorite editor, open the .ruby-gemset and .ruby-version files and verify latest version is showing :
...
2b. Create your gemset, then run bundle install :

<pre>
$ rvm use Ruby-2.1.0@Rails4.0.2_rails-stripe-membership-saas --create --default
$ bundle install
</pre>

3. Create your application.yml file from the application.example.yml file, using your own data.
4. Make sure /configuration/application.yml exists in your ./.gitignore file. (It is at the bottom of the file)
