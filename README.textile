...
This branch is a Rails 4.1.0 example application with recurring billing using Stripe.
This branch runs Ruby 2.1.0, and Bootstrap 3.0
Therefore, the instructions below will not always be in sync.
...
Use for a Rails membership site, subscription site, or SaaS site (software-as-a-service). Using:
