...
Further builds on this application are by Kathy Onu, for the "Good Works On Earth":https://goodworksonearth.net secure site.
This is the codebase for our "Sequencers Membership":https://www.goodworksonearth.net application.
...
Is the app useful to you? Follow the original project creator on Twitter: "@rails_apps":http://twitter.com/rails_apps and see what else Daniel Kehoe is doing.
