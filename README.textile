...
1. Clone the branch into your system :

    $ git clone -b rails4 https://github.com/kathyonu/rails-stripe-membership-saas.git
1a. Change Directory into the new app: $ cd rails-stripe-membership-saas
...
6. Run $ rake db:seed
7. Run $ rake db:test:prepare

You are now ready to run, and test your app.

8. To run your server: $ rails s and open your browser to http://localhost:3000
9. To run cucumber tests: $ cucumber
10. To run Rspec tests: $ rspec spec 
